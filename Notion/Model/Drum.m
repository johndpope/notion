...
- (id)initWithPitch:(int)_pitch octave:(int)_octave name:(NSString *)_name shortName:(NSString *)_shortName {
    if (self = [super init]) {
        ...
        shortName = [NSString stringWithString:_shortName];
    }
    return self;
}
...
- (id)initWithCoder:(NSCoder *)coder {
    if (self = [super init]) {
        ...
        name = [NSString stringWithString:[coder decodeObjectForKey:@"name"]];
        shortName = [NSString stringWithString:[coder decodeObjectForKey:@"shortName"]];
    }
    return self;
}
